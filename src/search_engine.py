...
class SearchEngine:
    ...
    def search_single_keyword(self, query: str, get_first_only: bool = True) -> Optional[SearchResult]:
        """
        ...
        try:
            ...
            # API検索を実行
            api_result = self.api.search(query, num=1 if get_first_only else 10)
